...
public class CacheFilter implements Filter {
    ...
    public void init(FilterConfig filterConfig) throws ServletException {
        try {
            expiration = Long.valueOf(
                filterConfig.getInitParameter(CacheConfigParameter.EXPIRATION.getName()));
            ...
            throw new ServletException(new StringBuilder("The initialization parameter ")
                ...
                .append(filterConfig.getFilterName())
                .append(".").toString());
        }
        cacheability =
            Boolean.valueOf(filterConfig.getInitParameter(CacheConfigParameter.PRIVATE.getName())) ?
                Cacheability.PRIVATE
                :
                Cacheability.PUBLIC;
        mustRevalidate = Boolean
            .valueOf(filterConfig.getInitParameter(CacheConfigParameter.MUST_REVALIDATE.getName()));
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse,
        ...
        StringBuilder cacheControl =
            new StringBuilder(cacheability.getValue()).append(", max-age=").append(expiration);
        if (mustRevalidate) {
        ...
        httpServletResponse
            .setHeader(HTTPCacheHeader.CACHE_CONTROL.getName(), cacheControl.toString());
